(ns me.lomin.sinho.timeout-jvm-test
  "CLJ-only timeout tests for thread safety and property-based testing.
   
   This namespace contains tests that can only run on the JVM:
   1. Thread safety tests (Threads not available in CLJS)
   2. Property-based tests using test.check (easier on JVM)"
...
;; ============================================================================
;; Property-Based Tests (JVM Only - for convenience)
;; ============================================================================
